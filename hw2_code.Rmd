...
The proportion of station entrances / exits without vending allow entrance is `r nrow(filter(NYC_df, vending == 'NO', entry == 'TRUE'))/r nrow(filter(NYC_df, vending == 'NO'))`

There are `r nrow(filter(NYC_df, route_name == 'A') %>% distinct (line, station_name))`stations that serve A train.
